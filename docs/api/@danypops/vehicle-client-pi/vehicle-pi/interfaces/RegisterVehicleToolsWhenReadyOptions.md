...
[Documentation](../../../../README.md) / [@danypops/vehicle-client-pi](../../README.md) / [vehicle-pi](../README.md) / RegisterVehicleToolsWhenReadyOptions

# Interface: RegisterVehicleToolsWhenReadyOptions

Defined in: [packages/vehicle-client-pi/src/vehicle-pi.ts:1173](https://github.com/DanyPops/vehicle/blob/aaa01ef790022c6466d83012d0b7f53d90e6e6d3/packages/vehicle-client-pi/src/vehicle-pi.ts#L1173)

## Extends

- [`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`approvalPresentation`](RegisterVehicleToolsOptions.md#approvalpresentation)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`closeClientOnSessionShutdown`](RegisterVehicleToolsOptions.md#closeclientonsessionshutdown)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`executionMode`](RegisterVehicleToolsOptions.md#executionmode)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`handshake`](RegisterVehicleToolsOptions.md#handshake)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`interactiveFollowUps`](RegisterVehicleToolsOptions.md#interactivefollowups)

***

### log?

> `readonly` `optional` **log?**: (`event`) => `void`

Defined in: [packages/vehicle-client-pi/src/vehicle-pi.ts:1175](https://github.com/DanyPops/vehicle/blob/aaa01ef790022c6466d83012d0b7f53d90e6e6d3/packages/vehicle-client-pi/src/vehicle-pi.ts#L1175)
...
[`VehicleReadyEvent`](../type-aliases/VehicleReadyEvent.md)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`manifestCache`](RegisterVehicleToolsOptions.md#manifestcache)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`modelContentMaxBytes`](RegisterVehicleToolsOptions.md#modelcontentmaxbytes)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`onInvoked`](RegisterVehicleToolsOptions.md#oninvoked)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`permissions`](RegisterVehicleToolsOptions.md#permissions)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`presentations`](RegisterVehicleToolsOptions.md#presentations)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`principal`](RegisterVehicleToolsOptions.md#principal)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`progressBarGlyphs`](RegisterVehicleToolsOptions.md#progressbarglyphs)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`renderers`](RegisterVehicleToolsOptions.md#renderers)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`requireApprovalForEffects`](RegisterVehicleToolsOptions.md#requireapprovalforeffects)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`resolveInvocation`](RegisterVehicleToolsOptions.md#resolveinvocation)

***

### retry?

> `readonly` `optional` **retry?**: [`VehicleReadyRetryOptions`](VehicleReadyRetryOptions.md)

Defined in: [packages/vehicle-client-pi/src/vehicle-pi.ts:1176](https://github.com/DanyPops/vehicle/blob/aaa01ef790022c6466d83012d0b7f53d90e6e6d3/packages/vehicle-client-pi/src/vehicle-pi.ts#L1176)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`safetyPolicyStore`](RegisterVehicleToolsOptions.md#safetypolicystore)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`shell`](RegisterVehicleToolsOptions.md#shell)
...
[`RegisterVehicleToolsOptions`](RegisterVehicleToolsOptions.md).[`toolName`](RegisterVehicleToolsOptions.md#toolname)
